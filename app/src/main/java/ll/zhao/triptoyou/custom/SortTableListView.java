...
/**
 * Created by amay077 on 2017-09-08
...
public class SortTableListView extends ListView implements
    ...
    /** コンストラクタ */
    public SortTableListView(Context context) {
        super(context);
        setOnItemLongClickListener(this);
    }

    /** コンストラクタ */
    public SortTableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOnItemLongClickListener(this);
    }

    /** コンストラクタ */
    public SortTableListView(Context context, AttributeSet attrs, int defStyle) {
